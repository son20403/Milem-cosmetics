<h1 style="text-align: left;background-color: antiquewhite; margin: 10px; padding: 20px;" class="text_tb">Tìm kiếm: <strong style="text-transform: uppercase;"><?php echo $keys ?></strong></h1>
<div class="row">
<?php
if ($data_keys == 0 || $keys == '') { ?>
    <!-- PRODUCTS -->
